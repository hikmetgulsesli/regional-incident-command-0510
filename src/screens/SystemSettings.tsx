  ...
  return (
    <>
      ...
      <nav className="hidden md:flex flex-col h-full w-64 bg-surface-container dark:bg-surface-container border-r border-outline-variant p-unit gap-base fixed left-0 top-0">
        ...
        <button
          className="flex items-center gap-3 px-4 py-3 text-on-surface-variant hover:text-on-surface hover:bg-surface-variant/50 transition-colors rounded-lg cursor-pointer active:opacity-80 transition-opacity"
        ...
        <main className="flex-1 overflow-y-auto p-container-padding bg-background">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <section className="bg-surface border border-outline-variant rounded-lg overflow-hidden">
                ...
                <div className="p-6 space-y-6">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <select
                      className="bg-background border border-outline-variant text-on-surface font-body-md rounded-DEFAULT px-4 py-2 focus:ring-primary-container focus:border-primary-container w-full sm:w-48 outline-none"
              ...
              <section className="bg-surface border border-outline-variant rounded-lg overflow-hidden border-l-4 border-l-error">
                <div className="px-6 py-4 border-b border-outline-variant bg-surface-container-low flex items-center gap-3">
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <button
                      className="px-6 py-2 bg-transparent border border-outline-variant text-error font-label-md text-label-md rounded-DEFAULT hover:bg-error-container/20 hover:border-error transition-colors focus:ring-2 focus:ring-error focus:ring-offset-2 focus:ring-offset-background outline-none h-touch-target flex items-center justify-center whitespace-nowrap"
                      onClick={() => {
