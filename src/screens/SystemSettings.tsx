...
export function SystemSettings(props: SystemSettingsProps) {
  return (
    <>
      ...
      <a className="flex items-center gap-3 px-4 py-3 text-on-surface-variant hover:text-on-surface hover:bg-surface-variant/50 transition-all rounded-lg cursor-pointer active:opacity-80 transition-opacity" href="#">
      ...
      <a className="flex items-center gap-3 px-4 py-3 bg-secondary-container text-on-secondary-container rounded-lg cursor-pointer active:opacity-80 transition-opacity" href="#">
      ...
      <button className="p-2 text-on-surface-variant hover:bg-surface-container-high transition-colors rounded-full cursor-pointer active:scale-95 transition-transform flex items-center justify-center">
      ...
      <select className="bg-[#0F172A] border border-[#334155] text-on-surface font-body-md rounded-DEFAULT px-4 py-2 focus:ring-primary-container focus:border-primary-container w-full sm:w-48 outline-none">
      <option>Tactical Map</option>
      <option selected={true}>Global Dashboard</option>
      ...
      <option selected={true}>1 Hour</option>
